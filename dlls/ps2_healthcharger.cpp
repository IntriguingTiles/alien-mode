	...
	if ( m_iJuice >= 1 )
	{
		if ( FindPlayer() )
		{
			...
			if ( m_flIdealArmYaw != m_flCurrentArmYaw )
			{
				...
				if ( m_flIdealArmYaw < m_flCurrentArmYaw )
				{
					m_flCurrentArmYaw -= min( m_flCurrentArmYaw - m_flIdealArmYaw, 5.0 );
				}
				else
				{
					m_flCurrentArmYaw += min( m_flIdealArmYaw - m_flCurrentArmYaw, 5.0 );
				}
			...
			if ( m_flIdealEyeYaw != m_flCurrentEyeYaw )
			{
				...
				if ( m_flIdealEyeYaw < m_flCurrentEyeYaw )
				{
					m_flCurrentEyeYaw -= min( m_flCurrentEyeYaw - m_flIdealEyeYaw, 5.0 );
				}
				else
				{
					m_flCurrentEyeYaw += min( m_flIdealEyeYaw - m_flCurrentEyeYaw, 5.0 );
				}
